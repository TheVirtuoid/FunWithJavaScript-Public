...
describe('Mineral Class', () => {
	...
	describe('Static Properties', () => {
		it('should have definitions for the 5 extractor types', () => {
			...
			expect(Mineral.LUMINITE).to.exist;
			expect(Mineral.OBSIDIANITE).to.exist;
			expect(Mineral.ZENITHITE).to.exist;
		});
	});
	...
	describe('Static Methods', () => {
		it('should return element using has()', () => {
			...
			expect(Mineral.Has(Mineral.LUMINITE)).to.be.true;
			expect(Mineral.Has(Mineral.OBSIDIANITE)).to.be.true;
			expect(Mineral.Has(Mineral.ZENITHITE)).to.be.true;
		});
