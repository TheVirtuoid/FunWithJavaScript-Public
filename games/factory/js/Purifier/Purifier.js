...
export default class Purifier extends Base {
	...
	static DATA = new Map([
		...
		[Purifier.PYROTITE, {
			base: { speed: 2500, purity: .6, capacity: 10, cost: 2500, upgrade: { speed: 5000, purity: 5000 }, level: 1.2 },
		...
		[Purifier.LUMINITE, {
			base: { speed: 3000, purity: .6, capacity: 10, cost: 5500, upgrade: { speed: 11000, purity: 11000 }, level: 1.2 },
		...
		[Purifier.OBSIDIANITE, {
			base: { speed: 3500, purity: .6, capacity: 10, cost: 12500, upgrade: { speed: 25000, purity: 25000 }, level: 1.2 },
		...
		[Purifier.ZENITHITE, {
			base: { speed: 4000, purity: .6, capacity: 10, cost: 25000, upgrade: { speed: 50000, purity: 50000 }, level: 1.2 },
