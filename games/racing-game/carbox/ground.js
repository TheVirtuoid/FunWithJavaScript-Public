...
const buildGround = (scene, physicsOptions) => {
	const { friction, restitution, rotationAmount, rotationAxis, yAdjust } = physicsOptions;
	...
	groundBase.visibility = true;
	groundBase.material = groundMaterial;
	groundBase.position = new Vector3(0, yAdjust, 0);
	...
	groundBaseWallNorth.position = new Vector3(-25, yAdjust, 0);
	...
	groundBaseWallSouth.position = new Vector3(25, yAdjust, 0);
	...
	groundBaseWallEast.position = new Vector3(0, yAdjust, 25);
	...
	groundBaseWallWest.position = new Vector3(0, yAdjust, -25);
